...
import com.tah.fourmetal.data.api.menus.MenuUpdateBody
import com.tah.fourmetal.data.api.menus.MenusService
...
class MenusViewModel constructor(
    ...
    suspend fun getMenus(id: Int) {
        viewModelScope.launch(Dispatchers.Default) {
            ...
            val retrofit = retrofitInstance.getInst().create(MenusService::class.java)
